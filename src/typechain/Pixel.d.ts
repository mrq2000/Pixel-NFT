...
export class Pixel extends BaseContract {
  ...
  functions: {
    ...
    nftData(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string]>;
  ...
  callStatic: {
    ...
    safeMint(data: string, overrides?: CallOverrides): Promise<void>;
